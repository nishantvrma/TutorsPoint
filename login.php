...
if(!isset($_SESSION)) 
  ...
  if(($_SESSION['email']) && ($_SESSION['password']) && ($_SESSION['user_type']=="guardian") ){
   header("Location: http://localhost/TutorFinder/gurdianadmin.php");
  }
  
  if(($_SESSION['email']) && ($_SESSION['password']) && ($_SESSION['user_type']=="teacher") ){
   header("Location: http://localhost/TutorFinder/teacheradmin.php");
  }
  if(($_SESSION['email']) && ($_SESSION['password']) && ($_SESSION['user_type']=="student") ){
   header("Location: http://localhost/TutorFinder/studentadmin.php");
 } 
  ?>
    ...
    <div class="container">
      ...
      <div class="row contact-wrap">
        ...
        <div class="col-md-6 col-md-offset-3">
          ...
          <form action="http://localhost/TutorFinder/inc/loginprocess.php" method="post" role="form" class="contactForm">
